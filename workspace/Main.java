...
public class Main 
{
  ...
  */
  ...
  {
     Country reviewCountry = countryArray[index];
     String reviewCountryString = reviewCountry.toString();
     System.out.println(reviewCountryString);
     outputLabel.setText(reviewCountryString);
  }
